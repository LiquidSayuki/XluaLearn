		    ...
		    try {
                ...
                if(gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    int _intId = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        DG.Tweening.TweenParams gen_ret = gen_to_be_invoked.SetId( _intId );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& translator.Assignable<object>(L, 2)) 
                {
                    object _objectId = translator.GetObject(L, 2, typeof(object));
                        ...
                        DG.Tweening.TweenParams gen_ret = gen_to_be_invoked.SetId( _objectId );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _stringId = LuaAPI.lua_tostring(L, 2);
                        ...
                        DG.Tweening.TweenParams gen_ret = gen_to_be_invoked.SetId( _stringId );
                        translator.Push(L, gen_ret);
