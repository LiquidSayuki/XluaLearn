		    ...
		    try {
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector3>(L, 1)&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<DG.Tweening.Ease>(L, 4)) 
                {
                    ...
                    DG.Tweening.Ease _easeType;translator.Get(L, 4, out _easeType);
                        ...
                        UnityEngine.Vector3 gen_ret = DG.Tweening.DOVirtual.EasedValue( _from, _to, _lifetimePercentage, _easeType );
                ...
                if(gen_param_count == 4&& translator.Assignable<UnityEngine.Vector3>(L, 1)&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<UnityEngine.AnimationCurve>(L, 4)) 
                {
                    ...
                    UnityEngine.AnimationCurve _easeCurve = (UnityEngine.AnimationCurve)translator.GetObject(L, 4, typeof(UnityEngine.AnimationCurve));
                        ...
                        UnityEngine.Vector3 gen_ret = DG.Tweening.DOVirtual.EasedValue( _from, _to, _lifetimePercentage, _easeCurve );
                        translator.PushUnityEngineVector3(L, gen_ret);
                ...
                if(gen_param_count == 5&& translator.Assignable<UnityEngine.Vector3>(L, 1)&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<DG.Tweening.Ease>(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)) 
                {
                    ...
                    float _overshoot = (float)LuaAPI.lua_tonumber(L, 5);
                        ...
                        UnityEngine.Vector3 gen_ret = DG.Tweening.DOVirtual.EasedValue( _from, _to, _lifetimePercentage, _easeType, _overshoot );
                        translator.PushUnityEngineVector3(L, gen_ret);
                ...
                if(gen_param_count == 6&& translator.Assignable<UnityEngine.Vector3>(L, 1)&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<DG.Tweening.Ease>(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 6)) 
                {
                    ...
                    float _period = (float)LuaAPI.lua_tonumber(L, 6);
                        ...
                        UnityEngine.Vector3 gen_ret = DG.Tweening.DOVirtual.EasedValue( _from, _to, _lifetimePercentage, _easeType, _amplitude, _period );
                        translator.PushUnityEngineVector3(L, gen_ret);
