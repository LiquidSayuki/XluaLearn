		    ...
		    try {
                ...
                if(gen_param_count == 9&& translator.Assignable<DG.Tweening.Core.DOGetter<UnityEngine.Vector3>>(L, 1)&& translator.Assignable<DG.Tweening.Core.DOSetter<UnityEngine.Vector3>>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 6)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 7)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 8)&& translator.Assignable<DG.Tweening.ShakeRandomnessMode>(L, 9)) 
                {
                    ...
                    DG.Tweening.ShakeRandomnessMode _randomnessMode;translator.Get(L, 9, out _randomnessMode);
                        ...
                        DG.Tweening.Core.TweenerCore<UnityEngine.Vector3, UnityEngine.Vector3[], DG.Tweening.Plugins.Options.Vector3ArrayOptions> gen_ret = DG.Tweening.DOTween.Shake( _getter, _setter, _duration, _strength, _vibrato, _randomness, _ignoreZAxis, _fadeOut, _randomnessMode );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 8&& translator.Assignable<DG.Tweening.Core.DOGetter<UnityEngine.Vector3>>(L, 1)&& translator.Assignable<DG.Tweening.Core.DOSetter<UnityEngine.Vector3>>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& translator.Assignable<UnityEngine.Vector3>(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 6)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 7)&& translator.Assignable<DG.Tweening.ShakeRandomnessMode>(L, 8)) 
                {
                    ...
                    DG.Tweening.ShakeRandomnessMode _randomnessMode;translator.Get(L, 8, out _randomnessMode);
                        ...
                        DG.Tweening.Core.TweenerCore<UnityEngine.Vector3, UnityEngine.Vector3[], DG.Tweening.Plugins.Options.Vector3ArrayOptions> gen_ret = DG.Tweening.DOTween.Shake( _getter, _setter, _duration, _strength, _vibrato, _randomness, _fadeOut, _randomnessMode );
                        translator.Push(L, gen_ret);
        ...
        static int _m_TotalActiveTweeners_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        int gen_ret = DG.Tweening.DOTween.TotalActiveTweeners(  );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
        ...
        static int _m_TotalActiveSequences_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        int gen_ret = DG.Tweening.DOTween.TotalActiveSequences(  );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<object>(L, 1)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)) 
                {
                    ...
                    bool _playingOnly = LuaAPI.lua_toboolean(L, 2);
                        ...
                        int gen_ret = DG.Tweening.DOTween.TotalTweensById( _id, _playingOnly );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
                ...
                if(gen_param_count == 1&& translator.Assignable<object>(L, 1)) 
                {
                    object _id = translator.GetObject(L, 1, typeof(object));
                        ...
                        int gen_ret = DG.Tweening.DOTween.TotalTweensById( _id );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
